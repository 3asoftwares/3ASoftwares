...
export default function ContactPage() {
    ...
    const handleChange = (field: keyof ContactForm) => (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    return (
        <>
            <NavBar />
            <div id='contact' className='bg-canvas relative overflow-hidden pt-20 pb-16'>
                <div className='section-glow' />
                <div className='relative mx-auto max-w-5xl px-6'>
                    <Reveal className='mb-8 text-center'>
                        <h1 className='text-fg font-display text-2xl font-bold sm:text-3xl'>Let's talk about your project</h1>
                        <p className='text-fg-muted mt-2 text-sm'>Tell us what you're building — we typically reply within one business day.</p>
                    </Reveal>
