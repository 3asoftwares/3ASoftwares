...
const Intro = () => {
    return (
        <>
            <div className='m-auto p-2 md:p-24 h-5/6' id='about'>
                <div className='flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left' data-aos='fade-up'>
                    <div className='lg:w-1/2 flex flex-col lg:mx-4 justify-center'>
                        <img alt='card img' className='rounded-t float-right' src={img.src} />
                    </div>
                    <div className='flex-col my-4 text-center lg:text-left lg:my-0 lg:justify-end w-full lg:w-1/2 px-8' data-aos='zoom-in' data-aos-delay='500'>
                        ...
                        <div>
                            <p className='my-3 text-xl text-gray-600 font-semibold'>
                                We take responsibility for building custom software solutions that caters for automation of your business processes and improve
                                efficiency.
                            </p>
                        </div>
                        <Link
