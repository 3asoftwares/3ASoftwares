    ...
    return (
        <>
            <div className='hero' id='hero'>
                ...
                <div className='m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:py-12 md:px-24 h-5/6' data-aos='zoom-in'>
                    <div id='hero' className='flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left'>
                        <div className='lg:w-1/2 flex flex-col justify-center' data-aos='zoom-in' data-aos-delay='200'>
                            <h1 className='mb-5 md:text-4xl text-2xl font-bold text-black'>Bespoke software solutions for your unique business needs</h1>
